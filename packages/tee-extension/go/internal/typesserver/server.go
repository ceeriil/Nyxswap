// Package typesserver is a lightweight HTTP sidecar that decodes raw
// hex-encoded instruction data into structured JSON, so frontends and
// debugging tools can display a payload without duplicating this repo's Go
// types in TypeScript. See docs/types-server.md (in the fce-orderbook
// reference this was ported from) for the full rationale.
package typesserver
