...
description: "Implement a Flare TEE (FCE) extension's business logic in packages/tee-extension — op types, handlers, and the matching Solidity send functions on InstructionSender.sol. Works for any implementation language. Use when the user wants to add an operation, write handlers, or implement their extension logic."
---
