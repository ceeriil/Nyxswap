---
name: test-extension
description: "Write and run E2E tests for the Flare TEE (FCE) extension in packages/tee-extension — response types, test payloads, and the on-chain send+poll+verify pattern. Use when the user wants to add test cases or test their extension, e.g. \"write tests for my extension\", \"test my extension\"."
---
