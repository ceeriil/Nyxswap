---
name: verify-deploy
description: "Diagnose deployment failures and verify config for the Flare TEE (FCE) extension in packages/tee-extension — runs the verify-deploy Go tool and interprets its D/R/S/V/T/E check codes. Use when the user wants to check their deployment setup, or a deploy is failing — e.g. \"verify my deployment\", \"why is deploy failing\", \"pre-flight check\"."
---
